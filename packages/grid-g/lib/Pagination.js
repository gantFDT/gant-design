...
var _default = exports.default = /*#__PURE__*/(0, _react.memo)(function GantPagination(props) {
  var addonAfter = props.addonAfter,
    ...
    countLimitStyle = props.countLimitStyle,
    resetProps = __rest(props, ["addonAfter", "addonBefore", "numberGoToMode", "onRefresh", "countLimit", "mode", "tooltipTotal", "total", "onChange", "current", "pageSize", "beginIndex", "defaultPageSize", "defaultCurrent", "size", "align", "Component", "countLimitStyle"]);
  ...
  var showSwitch = (0, _react.useMemo)(function () {
  ...
  })), addonAfter && /*#__PURE__*/_react.default.createElement("div", null, addonAfter)), showSwitch && ( /*#__PURE__*/_react.default.createElement(_Receiver.default, null, function (locale) {
...
function PaginationTotal(props) {
  ...
  if (limit) return /*#__PURE__*/_react.default.createElement(_Receiver.default, null, function (locale) {
    ...
    /*#__PURE__*/
    // 中文
    _react.default.createElement(_react.default.Fragment, null, "\u7B2C".concat(range[0], " - ").concat(range[1], "\u6761\uFF0C"), /*#__PURE__*/_react.default.createElement(_tooltip.default, {
