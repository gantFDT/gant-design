...
var _default = exports.default = (0, _react.memo)(function GantPagination(props) {
  var addonAfter = props.addonAfter,
    ...
    resetProps = __rest(props, ["addonAfter", "addonBefore", "numberGoToMode", "onRefresh", "countLimit", "mode", "tooltipTotal", "total", "onChange", "current", "pageSize", "beginIndex", "defaultPageSize", "defaultCurrent", "size", "align", "Component"]);
  ...
  var showTotal = (0, _react.useCallback)(function (total, range) {
    return _react.default.createElement(PaginationTotal, {
      total: total,
      range: range,
      limit: limit,
  ...
  }, addonBefore && _react.default.createElement("div", null, addonBefore), _react.default.createElement(PaginationComponent, Object.assign({
    className: "gant-grid-pagination"
  }, (0, _lodash.omit)(paginationProps, numberGoToMode ? ['showQuickJumper', 'quickGo'] : []))), numberGoToMode && _react.default.createElement(NumberGoTo, Object.assign({}, (0, _lodash.pick)(paginationProps, ['quickGo', 'disabled', 'showQuickJumper', 'pageSize', 'total', 'goButton', 'size']), {
    onPageChange: onPageChange
  })), onRefresh && _react.default.createElement(_button.default, {
    icon: "reload",
    size: size,
  ...
  }), addonAfter && _react.default.createElement("div", null, addonAfter)), mode === 'limit' && _react.default.createElement(_Receiver.default, null, function (locale) {
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("label", {
      style: {
        marginLeft: 4
      }
    }, "".concat(locale.exactSearch).concat(locale.targetLang === 'zh-CN' ? '：' : ':')), _react.default.createElement(_switch.default, {
...
function PaginationTotal(props) {
  ...
  if (limit) return _react.default.createElement(_Receiver.default, null, function (locale) {
    return locale.targetLang === 'zh-CN' ?
    // 中文
    _react.default.createElement(_react.default.Fragment, null, "\u7B2C".concat(range[0], " - ").concat(range[1], "\u6761\uFF0C").concat(propsTotal, "+ "), _react.default.createElement(_tooltip.default, {
  ...
  return _react.default.createElement(_Receiver.default, null, function (locale) {
    return locale.targetLang === 'zh-CN' ? _react.default.createElement(_react.default.Fragment, null, "\u7B2C".concat(range[0], " - ").concat(range[1], "\u6761\uFF0C\u5171").concat(propsTotal, "\u6761")) : _react.default.createElement(_react.default.Fragment, null, "".concat(range[0], "-").concat(range[1], " ").concat(locale.of, " ").concat(propsTotal, " ").concat(locale.items));
  });
}
var NumberGoTo = function NumberGoTo(props) {
  ...
  return _react.default.createElement(_Receiver.default, null, function (locale) {
    ...
    }, locale.jumpTo, _react.default.createElement(_inputNumber.default, {
      ref: inputRef,
      size: size,
      min: 1,
      max: max,
...
var paginationShowTotal = exports.paginationShowTotal = function paginationShowTotal(total, range, limit, tooltipTotal) {
  return _react.default.createElement(PaginationTotal, {
    total: total,
    range: range,
    limit: limit,
