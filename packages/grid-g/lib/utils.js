...
//大小
var sizeNumber = exports.sizeNumber = {
  small: 24,
  default: 32,
  large: 40
};
...
var selectedMapColumns = exports.selectedMapColumns = function selectedMapColumns(columns) {
...
var toFormMap = exports.toFormMap = function toFormMap(columns, params) {
  var customFields = [];
  var valueMap = {};
  var schema = {
    type: 'object',
...
var mapColumns = exports.mapColumns = function mapColumns(columns, getRowNodeId, defaultSelection, defaultSelectionCol, rowSelection, serialNumber, size) {
  // 移除所有已添加事件
...
//   }
// }
var AG_GRID_STOP_PROPAGATION = exports.AG_GRID_STOP_PROPAGATION = '__ag_Grid_Stop_Propagation';
