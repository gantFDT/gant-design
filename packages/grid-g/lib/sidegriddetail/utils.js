...
//通过grid行转列, 即数据
var getTransData = function getTransData(columns, data) {
  var res = [];
...
exports.getTransData = getTransData;

var transColumnsToObj = function transColumnsToObj(columns) {
  var res = {};
...
exports.transColumnsToObj = transColumnsToObj;

var getColDef = function getColDef(columnDefs, fieldName) {
  var res = {};
  var q = columnDefs;
...
var getValueGetter = function getValueGetter(params) {
...
exports.getValueGetter = getValueGetter;

var getInitValueFormatter = function getInitValueFormatter(params) {
  var fieldName = params.fieldName,
      columnField = params.columnField,
      clickedEvent = params.clickedEvent,
      cellValue = params.cellValue;
...
exports.getInitValueFormatter = getInitValueFormatter;

var getValueRender = function getValueRender(params) {
  var fieldName = params.fieldName,
      columnField = params.columnField,
      clickedEvent = params.clickedEvent,
      cellValue = params.cellValue;
...
exports.getValueRender = getValueRender;

var getEditable = function getEditable(params) {
...
var getDiffProps = function getDiffProps(srcObj, targetObj) {
  var res = {};
...
exports.getDiffProps = getDiffProps;

var getOriginData = function getOriginData(data) {
