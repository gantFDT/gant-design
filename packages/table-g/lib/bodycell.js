...
var BodyCell = function BodyCell(_a) {
  ...
  var _useState7 = (0, _react.useState)(_dataCell.EditStatus.CANCEL),
  ...
  var isEdit = (0, _react.useMemo)(function () {
    return edit === _dataCell.EditStatus.EDIT;
  }, [edit]);
  ...
  var close = (0, _react.useCallback)(function () {
    return setedit(_dataCell.EditStatus.CANCEL);
  }, []); // 设置编辑值的初始值
  ...
  (0, _react.useEffect)(function () {
    if (editable === _dataCell.EditStatus.SAVE) {
      // 清除脏标记
      setCacheInitialValue(value);
    } else if (editable === _dataCell.EditStatus.CANCEL && !_lodash.default.isEqual(cacheInitialValue, value)) {
      // 回退值
      setValue(cacheInitialValue); // 曾经编辑过
  ...
  }, [editable, value, cacheInitialValue, element]); // fix bug 可拖拽排序的课编辑表格，在进入编辑状态的时候会重新排列，因此rowIndex可能会不一样
  ...
  }, [dataIndex, rowIndex]); // 切换显示状态

  var switchEdit = (0, _react.useCallback)(function () {
    if (editable !== _dataCell.EditStatus.EDIT || !editRender) return false;
    setedit((0, _dataCell.SwitchStatus)(edit));
    return true;
  ...
  var onBlur = (0, _react.useCallback)(function () {
    ...
    switchEdit();
  }, [value, element, switchEdit, isTree, dataSource]); // 更新树状数据
  ...
  var getCurrentRecord = (0, _react.useCallback)(function (_ref5, value) {
    ...
    var seted = false;
    var index = 0;
    var item = list[rowIndex]; // 比如：更新树状table的时候，第一层数据只有2条数据，而更新的数据是下面某一层中的第3条数据
  ...
  var renderChildren = (0, _react.useCallback)(function () {
    ...
    if (element) {
      ...
      return /*#__PURE__*/_react.default.cloneElement(element, elementProps);
    }
  ...
  var renderTd = (0, _react.useCallback)(function () {
    ...
    var computedClassName = (0, _classnames2.default)(className, wrapClass, (0, _defineProperty2.default)({}, getPrefixCls('table-editcell-dirt'), showDirt && valueChanged)); //fix Cannot assign to read only property
    ...
    if (virtualScroll) {
      ...
      if (originLineHeight) {// dStyle.lineHeight = originLineHeight
      }
    }

    return /*#__PURE__*/_react.default.createElement("td", Object.assign({}, props, {
      style: dStyle,
