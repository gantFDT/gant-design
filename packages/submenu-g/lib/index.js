...
var Submenu = exports.default = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2.default)(Submenu, [{
    ...
    value: function renderSubMenu(prefixCls) {
      ...
      return _react.default.createElement(_menu.default, Object.assign({
        className: prefixCls,
        ...
        return _react.default.createElement(_menu.default.Item, {
          ...
          key: item.key
        }, typeof item.icon == 'string' ? _react.default.createElement(_dataCell.Icon, {
          type: item.icon,
          wrapperStyle: {
            width: 'auto'
          }
        }) : item.icon, _react.default.createElement("span", null, item.title), item.count && _react.default.createElement("span", {
    ...
    value: function renderInlineMenu(prefixCls) {
      ...
      }, _react.default.createElement(_dataCell.Icon.Ant, {
    ...
    value: function renderHorMenu(prefixCls) {
      ...
      }, this.renderSubMenu(prefixCls))), _react.default.createElement("div", {
    ...
    value: function render() {
      ...
      }, isInline ? this.renderInlineMenu(this.prefixCls) : this.renderHorMenu(this.prefixCls), _react.default.createElement("div", {
        className: "".concat(this.prefixCls, "-pagecard")
      }, _react.default.createElement(_react.default.Fragment, null, children), menuData.length > 0 && showFlipOverFooter && _react.default.createElement(_FlipOverFooter.default, {
