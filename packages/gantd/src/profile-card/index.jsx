        ...
        {mode === 'tags' ? (
          ...
          <Tooltip placement="bottomLeft" title={value}>
            <p
              ...
              style={{ color: value ? 'rgba(0,0,0,.9)' : '#ccc' }}
            >
              {value}
            </p>
          </Tooltip>
  ...
  renderWithConfigConsumer = ({ getPrefixCls }) => {
    ...
    const content = (
      <div
        ...
        style={{ height: height || 'auto', paddingBottom: extraBottom && 40 }}
      >
        ...
        <div
          className={classnames(
            `${prefixCls}-fields`,
            labelAlign == 'left' && 'dataform',
            avatarAlign,
          )}
          style={{ width: children ? 'auto' : 'auto' }}
        >
          <Form labelAlign={labelAlign}>{this.getField(fields)(false)}</Form>
        </div>
