...
var Header = function Header(headerProps) {
  ...
  var _useState3 = (0, _react.useState)({}),
      ...
      setInnerExtra = _useState4[1]; //打平extra
    ...
    var interator = function interator(items) {
      _react.default.Children.map(items, function (item, index) {
        if (item && item.type && item.type.toString() === 'Symbol(react.fragment)') {
          ...
          if ( /*#__PURE__*/_react.default.isValidElement(item) || typeof item === 'string') {
            toolsArr.push(item);
          }
        }
      });
  ...
  return /*#__PURE__*/_react.default.createElement("div", Object.assign({
  ...
  }, restProps), extra && /*#__PURE__*/_react.default.createElement(_reactResizeDetector.default, {
    handleWidth: true,
    handleHeight: true,
    key: 1
  ...
  }, beforeExtra), type == 'icon' && /*#__PURE__*/_react.default.createElement("div", {
    ...
    icon: icon
  }), type == 'line' && title && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }), type == 'num' && /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, extra && !suppressMap && /*#__PURE__*/_react.default.createElement(_ExtraContent.default, {
    tools: tools,
    prefixCls: prefixCls,
    width: toolWidth
  }), suppressMap && /*#__PURE__*/_react.default.createElement("div", {
