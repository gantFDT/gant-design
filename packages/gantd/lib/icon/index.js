...
var IconHouse = function IconHouse(_a) {
  ...
  var prefixCls = 'gant-icon-selector';
  // 图标抽屉
  ...
  return _react.default.createElement(_Receiver.default, null, function (locale) {
    ...
    }, currentId ? _react.default.createElement(_Icon.default, Object.assign({
      type: currentId,
      title: locale.clickToggle,
      perfix: perfix
    }, props)) : _react.default.createElement("span", {
      className: prefixCls + '-btn'
    }, locale.clickSelect)), _react.default.createElement(_drawer.default, {
      width: visible ? 500 : 0,
    ...
    }, iconsWithFilter.length ? null : _react.default.createElement(_empty.default, {
...
var IconSelector = exports.IconSelector = (0, _recompose.compose)(_recompose.toClass, (0, _recompose.defaultProps)(defaultprops), (0, _recompose.withProps)(function (_ref) {
  ...
  var cStyle = Object.assign({}, wrapperStyle);
  ...
  var element = _react.default.createElement(_Icon.default, {
    type: value,
    perfix: perfix,
    style: style,
    theme: theme,
