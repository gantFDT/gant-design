...
function delCookie(name) {
  var exp = new Date();
  exp.setTime(exp.getTime() - 1000000); // 这里需要判断一下cookie是否存在
...
var deepCopy4JSON = function deepCopy4JSON(obj) {
...
exports.deepCopy4JSON = deepCopy4JSON;

var JSONisEqual = function JSONisEqual(a, b) {
...
exports.JSONisEqual = JSONisEqual;

var isParamsEmpty = function isParamsEmpty(value) {
...
exports.isParamsEmpty = isParamsEmpty;
...
function array2Tree(data) {
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (node.parentId === parentId) {
      ...
      var newNode = Object.assign(Object.assign({}, node), (_Object$assign = {}, (0, _defineProperty2.default)(_Object$assign, keyName, node.id), (0, _defineProperty2.default)(_Object$assign, "children", children), _Object$assign));
...
var getPerformanceTiming = function getPerformanceTiming() {
  ...
  obj['redirectTime'] = t.redirectEnd - t.redirectStart; // DNS查询耗时

  obj['lookupDomainTime'] = t.domainLookupEnd - t.domainLookupStart; // TCP链接耗时

  obj['connectTime'] = t.connectEnd - t.connectStart; // HTTP请求耗时

  obj['requestTime'] = t.responseEnd - t.responseStart; // 解析dom树耗时

  obj['domReadyTime'] = t.domComplete - t.domInteractive; // 白屏时间耗时

  obj['whiteTime'] = t.responseStart - t.navigationStart; // DOMready时间

  obj['domLoadTime'] = t.domContentLoadedEventEnd - t.navigationStart; // 页面加载完成的时间 即：onload时间
