...
var PrimaryColors = exports.PrimaryColors = Object.entries(_colors.presetPalettes).map(function (_ref) {
...
var validColorText = exports.validColorText = function validColorText(_) {
  var reg = /^([0-9a-fA-F]{6}|[0-9a-fA-F]{3})$/;
  return reg.test(_);
};
var fillText = exports.fillText = function fillText(_) {
