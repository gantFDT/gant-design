...
})), _dec(_class = (_Select = /*#__PURE__*/function (_React$Component) {
  function Select() {
    var _this;
    ...
    _this = _callSuper(this, Select, [].concat(_args));
    (0, _defineProperty2.default)(_this, "onSelect", function () {
    ...
    (0, _defineProperty2.default)(_this, "onChange", function (selected) {
    ...
    (0, _defineProperty2.default)(_this, "renderSelect", function () {
...
}(_react.default.Component), (0, _defineProperty2.default)(_Select, "properTypes", {
