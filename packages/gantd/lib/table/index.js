...
var defaultProps = {
  ...
  rowSelection: null,
  isZebra: true,
  editable: _editStatus.default.CANCEL,
  wrap: false,
  footerDirection: 'row',
  orderList: [],
  light: false,
...
var GantTableList = function GantTableList(props, ref) {
  ...
  var isEdit = (0, _react.useMemo)(function () {
    return editable === _editStatus.default.EDIT;
  }, [editable]);
  ...
  var _useState13 = (0, _react.useState)(0),
    ...
    setEmitReCompute = _useState14[1];
  // 业务层修改editable状态的时候，计算修改前后数据的
  (0, _react.useEffect)(function () {
    if (editable === _editStatus.default.SAVE && !lock) {
      // 保存之后，锁上保证下次更新不会再次进入
      setLock(true);
      console.time('计算diff');
  ...
  var footerCallback = (0, _react.useCallback)(function (currentPageData) {
    return _react.default.createElement(_react.default.Fragment, null, currentPageData.length ? footerselection : null, _react.default.createElement("div", {
    ...
    }, typeof props.tail === 'function' && props.tail(currentPageData)), computedPagination && _react.default.createElement(_pagination.default, Object.assign({
      size: 'small'
    }, computedPagination))));
  ...
  var scrollError = (0, _react.useMemo)(function () {
    if (scrollY) {
      // 最后一屏之前渲染的条数
      var leave = renderRowKeys.length - thresholdInner;
      // 最大滚动高度
      var maxScroll = mainHeight - parseInt(scrollY);
      // 最多滚动多少条
      var maxScrollLength = Math.floor(maxScroll / rowHeight);
      // 偏差条数
  ...
  var onVScroll = (0, _react.useCallback)(function (e) {
    ...
    var outTopLine = outTopLinevir + (scrollError > 0 ? Math.floor(outTopLinevir / scrollError) : 0);
    // 设置数据
  ...
  var onCell = (0, _react.useCallback)(function (col, record, rowIndex, _ref2) {
    ...
    var dataIndex = col.dataIndex,
      ...
      fixed = col.fixed;
    var cellEditable = _lodash.default.isPlainObject(editConfig) && !_lodash.default.isEmpty(editConfig);
    // 修正rowIndex值
    var computedRowIndex = rowIndex + outlineNum;
    // 虚拟滚动或者带有固定列的表格不换行
  ...
  var convertColumns = (0, _react.useCallback)(function (cols) {
    ...
    var computedCols = cols.map(function (_a, index) {
      var width = _a.width,
        ...
        col = __rest(_a, ["width", "onHeaderCell", "onCell", "render"]);
      // 添加自定义render
      col.render = function () {
  ...
  }, [resizeCell, _bodywrapper.default, sortable, _headercell.default]);
  //#endregion
  var tableColumns = (0, _react.useMemo)(function () {
    return convertColumns(columns);
  }, [columns, convertColumns, orderList]);
  // dataIndex的索引
  ...
  var headerRightElement = (0, _react.useMemo)(function () {
    ...
    return _react.default.createElement(_react.default.Fragment, null, actions, headerRight);
  ...
  var renderTable = function renderTable() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, (title || headerRightElement || headerLeft) && _react.default.createElement(_header.default, Object.assign({
      title: title
    }, headerProps, {
      beforeExtra: headerLeft,
      extra: headerRightElement
    })), _react.default.createElement(_context.DataContext.Provider, {
      value: dataContextValue
    }, _react.default.createElement(_context.TableContext.Provider, {
      value: tableContextValue
    }, _react.default.createElement(_context.TableBodyWrapperContext.Provider, {
      ...
      className: (0, _classnames2.default)(className, tablePrefixCls, (0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)((0, _defineProperty2.default)({}, reizetablePrefixCls, resizeCell), zebraPrefixCls, !light && isZebra), sortablePrefixCls, sortable), lightPrefixCls, light)),
...
GTable.propTypes = {
  ...
  editable: _propTypes.default.oneOf([_editStatus.default.EDIT, _editStatus.default.CANCEL, _editStatus.default.SAVE]),
...
var GantTable = exports.default = /*#__PURE__*/function (_React$Component) {
  (0, _inherits2.default)(GantTable, _React$Component);
  function GantTable() {
    (0, _classCallCheck2.default)(this, GantTable);
    return _callSuper(this, GantTable, arguments);
  }
  (0, _createClass2.default)(GantTable, [{
    key: "render",
    value: function render() {
      return _react.default.createElement(GTable, Object.assign({}, this.props));
    }
  }]);
  return GantTable;
