...
var tableWrapperRef = (0, _recompose.compose)((0, _recompose.withState)('tableWraper', 'settableWraper', null), (0, _recompose.withProps)(function (_ref) {
...
exports.tableWrapperRef = tableWrapperRef;
var scrollIntoViewWithRowKey = (0, _recompose.compose)((0, _recompose.withPropsOnChange)(['scrollKey'], function (_ref2) {
...
exports.scrollIntoViewWithRowKey = scrollIntoViewWithRowKey;