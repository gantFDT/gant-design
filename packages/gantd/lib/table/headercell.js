...
var antSelectionCol = 'ant-table-selection-col';
// 获取移动相关的数据
...
function HeaderCell(props) {
  ...
  var _useContext2 = (0, _react.useContext)(_context.TableContext),
    onResize = _useContext2.onResize;
  // 计算col的序号
  ...
  var addMouseDownEvent = (0, _react.useCallback)(function (event) {
    ...
    var mouseMove = function mouseMove(e) {
      ...
      //#region
      var resultWidth = Math.max(minWidth, width + diffX);
      // 实际移动的距离
      var disX = resultWidth - width;
      var resultTableWidth = tableWidth + disX;
      // 设置cell宽度
      ...
      if (diffX < 0) {
        ...
        for (var i = 0, len = left.length; i < len; i++) {
          var _leftInit$i = (0, _slicedToArray2.default)(leftInit[i], 1),
            _width = _leftInit$i[0];
          var need = distribArr[i];
          if (need !== 0) {
            setWidth(left[i], _width + need);
            if (bodyLeft) {
              setWidth(bodyLeft[i], _width + need);
            }
          }
        }
        // 将实际移动的距离分配给右边的列
        var _rightInit$ = (0, _slicedToArray2.default)(rightInit[0], 1),
          _width2 = _rightInit$[0];
        setWidth(right[0], _width2 + reset - diffX);
        if (bodyRight) {
          setWidth(bodyRight[0], _width2 + reset - diffX);
        }
      } else {
        // 右移动
        ...
        for (var _i = 0, _len = right.length; _i < _len; _i++) {
          var _rightInit$_i = (0, _slicedToArray2.default)(rightInit[_i], 1),
            _width3 = _rightInit$_i[0];
          var _need3 = _distribArr[_i];
          if (_need3 !== 0) {
            setWidth(right[_i], _width3 - _need3);
            if (bodyRight) {
              setWidth(bodyRight[_i], _width3 - _need3);
            }
          }
        }
        var _leftInit$ = (0, _slicedToArray2.default)(leftInit[0], 1),
          _width4 = _leftInit$[0];
        setWidth(left[0], _width4 + diffX - _reset);
        if (bodyLeft) {
          setWidth(bodyLeft[0], _width4 + diffX - _reset);
        }
      }
    };
    var mouseUp = function mouseUp(e) {
  ...
  return _react.default.createElement("th", Object.assign({}, resetProps, {
    ...
    ref: thRef
  }), children, !isSelection && orderType && _react.default.createElement("span", {
    className: 'gantd-table-header-sort'
  }, _react.default.createElement(_icon.default, {
    type: orderTypeIcon.get(orderType),
    theme: "filled"
  })), useHandle && _react.default.createElement("span", {
