...
var GridDetail = function GridDetail(props) {
  ...
  var gridManagerRef = (0, _react.useRef)(null);
  //序号
    ...
    return [{
      ...
      editConfig: {
        component: function component(params) {
          return _react.default.createElement(_CombEditComponent.default, Object.assign({}, params, {
            fields: fields
          }));
        },
  ...
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
    ...
    type: "profile"
  }), " ", '行详情'), _react.default.createElement(_icon.default, {
    type: "close",
...
var _default = exports.default = GridDetail;
var barStyle = {
  padding: '0 10px',
  height: headerHeight,
  display: 'flex',
