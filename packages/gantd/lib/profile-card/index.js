...
var ProfileCard = (_dec = _form.default.create(), _dec(_class = (_ProfileCard = /*#__PURE__*/function (_Component2) {
  function ProfileCard() {
    ...
    (0, _defineProperty2.default)(_this, "getField", function (fields) {
    ...
    (0, _defineProperty2.default)(_this, "renderWithConfigConsumer", function (_ref) {
  ...
  return (0, _createClass2.default)(ProfileCard, [{
    key: "render",
    value: function render() {
