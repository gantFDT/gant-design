...
var setProps = function setProps(extraProps) {
...
function SmartGrid(smartGridProps) {
  ...
  var managerRef = (0, _react.useRef)(null); //Grid渲染完成之后的回调方法
  ...
  (0, _react.useEffect)(function () {
    ...
    if (viewKey !== usedView.viewId) setLastViewKey(usedView.viewId); // onViewChange && onViewChange(usedView); 接口自定义视图，customViewsProp属性冲突
  ...
  var _useMemo2 = (0, _react.useMemo)(function () {
    return (0, _hooks.useTableConfig)({
      ...
      finalColumns = _useMemo3[0]; // 动态列修改用户自定义视图
  ...
  var TableTitle = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react.default.createElement(_Receiver.default, null, function (locale) {
      return /*#__PURE__*/_react.default.createElement(_viewpicker.default, {
        ...
        splitLine: !!title,
        config: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_tooltip.default, {
          title: locale.sync
  ...
  var HeaderRightElem = (0, _react.useMemo)(function () {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, headerRight, onReload && /*#__PURE__*/_react.default.createElement(_Receiver.default, null, function (locale) {
  ...
  }, /*#__PURE__*/_react.default.createElement(GetLocale, {
    setLocale: setLocale
  }), !hideHeader && /*#__PURE__*/_react.default.createElement(_header.default, Object.assign({
    title: /*#__PURE__*/_react.default.createElement("div", {
      ref: titleRef
    }, title, TableTitle),
    extra: HeaderRightElem
  }, headerProps)), (0, _keyevent.default)(bindKeys, true)( /*#__PURE__*/_react.default.createElement(_grid.default, Object.assign({
    rowkey: rowkey,
  ...
  }, restProps))), /*#__PURE__*/_react.default.createElement(_config.default, {
