...
var GantAnchor = function GantAnchor(props) {
  ...
  var handleScroll = (0, _react.useCallback)(function (e) {
    ...
    if (fixedEle && stateMode == 'horizontal') {
      ...
      var isWindow = container == window;
      // 容器距离浏览器顶部的距离
      var containerScrollTop = isWindow ? 0 : (_c = (_b = (_a = container) === null || _a === void 0 ? void 0 : _a.getBoundingClientRect) === null || _b === void 0 ? void 0 : _b.call(_a)) === null || _c === void 0 ? void 0 : _c.top;
      // 滚动条滚动的距离
  ...
  return _react.default.createElement("div", {
    ...
    }, _react.default.createElement(_react.default.Fragment, null, item.title, item.complete ? _react.default.createElement(_icon.default, {
      type: "check-circle",
      theme: "twoTone",
      twoToneColor: "#52c41a",
      style: {
  ...
  }, _react.default.createElement(_anchor.default, Object.assign({
    offsetTop: fixedTop,
    ...
    }, _react.default.createElement(_anchor.default.Link, {
      key: item.key || item.title,
      href: "#".concat(item.id || item.title),
      title: _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_tooltip.default, {
        title: item.title,
        placement: "left"
      }, item.title), item.complete ? _react.default.createElement(_icon.default, {
        type: "check-circle",
        theme: "twoTone",
        twoToneColor: "#52c41a",
        style: {
...
var _default = exports.default = GantAnchor;