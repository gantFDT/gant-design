 ...
 * 查找依赖项
 */
var findDependencies = exports.findDependencies = function findDependencies(changedValueObject, _a, mapSubSchema, form) {
...
var refHoc = exports.refHoc = (0, _recompose.compose)(_react.default.forwardRef, function (BC) {
  return function (_a, ref) {
    var wrappedComponentRef = _a.wrappedComponentRef,
      props = __rest(_a, ["wrappedComponentRef"]);
    var factory = _react.default.createFactory(BC);
    return factory(Object.assign(Object.assign({}, props), {
      onRef: ref || wrappedComponentRef
    }));
  };
});
var _default = exports.default = (0, _recompose.compose)((0, _recompose.withStateHandlers)(function (_ref) {
