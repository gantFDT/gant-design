...
function SchemaForm(props) {
  ...
  var renderPropTypeContent = (0, _react.useCallback)(function (item, pathName, required) {
    ...
    switch (type) {
      ...
      default:
        ...
        return _react.default.createElement(_SchemaField.default, Object.assign({
          key: pathName
        }, item, {
          title: filedTitle,
          name: pathName,
  ...
  var renderContent = (0, _react.useCallback)(function (pathName) {
    ...
    var propertyTypeArray = Object.keys(propertyType);
    //处理排序
    var orderKeys = (0, _utils.getOrders)(orders, propertyTypeArray);
    //处理编辑状态；
    var filedEdit = (0, _utils.getEdit)(edit, pathName);
    //处理header
    ...
    return _react.default.createElement("div", {
      className: (0, _classnames.default)("".concat(prefixCls, "-schemaCard"), filedEdit === _dataCell.EditStatus.EDIT && "".concat(prefixCls, "-showRequiredMark"), className),
      key: pathName,
      style: Object.assign({
        backgroundColor: containerColor,
        padding: padding
      }, style)
    }, (pathName ? visible : title) && _react.default.createElement(_header.default, Object.assign({
      title: title,
      style: {
        marginBottom: 16
      }
