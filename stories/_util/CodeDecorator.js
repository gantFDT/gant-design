...
const getCodePenStr = (title, description, code) => {
    ...
    const codePenData = {
        ...
        js_external: `https://unpkg.com/react@16.x/umd/react.development.js;https://unpkg.com/react-dom@16.x/umd/react-dom.development.js;https://cdn.jsdelivr.net/npm/lodash@4.17.15/lodash.min.js;https://cdn.bootcss.com/Mock.js/1.0.1-beta3/mock-min.js;https://unpkg.com/moment/min/moment-with-locales.js;https://unpkg.com/antd@3.26.13/dist/antd.min.js;https://unpkg.com/react-router-dom/umd/react-router-dom.min.js;https://unpkg.com/react-router@3.x/umd/ReactRouter.min.js;https://unpkg.com/${name}@${version}/dist/${name}.js`,
