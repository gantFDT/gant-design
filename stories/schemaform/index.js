...
import { setGlobalConfig } from '@schema-form';
  ...
  return (
    <div style={{ margin: 10 }}>
      ...
      <div style={{ float: 'right' }}>
        ...
        <Button size="small" onClick={onReset} style={{ marginLeft: 5 }}>
          重置
        </Button>
        <a
          style={{ marginLeft: 5 }}
  ...
  return (
    <div style={{ margin: 10 }}>
      <div style={{ display: 'flex' }}>
        <div style={{ width: 300 }}>
          <p>
            key_1：<span>{data.key_1}</span>
          </p>
          <p>
            key_2：<span>{data.key_2}</span>
          </p>
        </div>
        <div style={{ flex: 1 }}>
          <SchemaForm
...
const config = {
  ...
  useage: (
    <>
      <p>
        表单是业务开发中最常见的业务场景，复杂表单的复杂程度往往需要我们使用大量的代码与时间去构建一个表单业务。SchemaForm由此诞生：
      </p>
      <ul>
